<template>
    <div>
        ...
        <div>The results of our study can be seen in this site. If you want to access our code, please click <a href="https://github.com/stergiosbamp/us-politics-analysis">here</a>.</div>
    </div>
</template>
